...
import { useCancelConnectionRequest } from "../../hooks/useAuth";
const ProfileHeader = ({ userData, onSave, isOwnProfile }) => {
  ...
  }, [isConnected, connectionStatus?.data?.status]);
        ...
        return (
          <>
            <div className="flex gap-2 justify-center">
              ...
              <button
                onClick={() => cancelRequest(connectionStatus?.data?.requestId)}
                className={`${baseClass} bg-gray-400 hover:bg-gray-500`}
              >
                Cancel Request
              </button>
            </div>
