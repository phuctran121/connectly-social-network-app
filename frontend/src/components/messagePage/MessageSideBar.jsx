...
const MessageSidebar = () => {
  ...
  const { mutate: markMessagesAsRead, isPending } = useMarkMessagesAsRead();
  ...
  const authUser = queryClient.getQueryData(["authUser"]); // Lấy authUser từ cache
